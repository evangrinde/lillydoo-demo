<template>
  <div class="grid-x grid-padding-x">
    <div
      ...
      v-for="(contents, ix) in packageContents"
      v-show="!contents.rules || contents.rules.includes(selectedOption)"
      :key="ix"
    >
      <contents
...
export default {
  ...
  components: {
    Contents: () => import("@/components/micro/Contents")
  },
  data() {
    return {
      /*
